...
class BlogPost(db.Model):
    ...
    author_id = db.Column(db.Integer, db.ForeignKey("users_1.id"))
    author = relationship("User_1", back_populates="posts")
...
class Comment(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    author_id = db.Column(db.Integer, db.ForeignKey("users_1.id"))
    comment_author = relationship("User_1", back_populates="comments")
...
def register():
    ...
    if form.validate_on_submit():
        ...
        if User_1.query.filter_by(email=form.email.data).first():
            # Send flash messsage
